...
public class ItemGrantSword extends Item {

	private int weaponDamage;
    private final EnumGrantToolMaterial toolMaterial;

    public ItemGrantSword(int par1, EnumGrantToolMaterial par2EnumToolMaterial)
    {
        super(par1);
