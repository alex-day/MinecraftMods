...
public class Block
{
     ...
     * Args: World, X, Y, Z, direction. If isBlockNormalCube returns true, standard redstone propagation rules will
     * apply instead and this will not be called.
     */
    ...
    /**
     * NODE: sets the unlocalized name
     */
