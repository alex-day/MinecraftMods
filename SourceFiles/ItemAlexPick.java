...
public class ItemAlexPick extends ItemToolAlex {
	
    protected ItemAlexPick(int par1, EnumAlexToolMaterial par2EnumToolMaterial)
    {
    ...
    static {
    	...
    	blocksEffectiveAgainst.add(mod_Alex.blockNetherQuartz);
    }
