...
public class ItemGantHoe extends Item{
	
	 protected EnumGrantToolMaterial theToolMaterial;

	    public ItemGantHoe(int par1, EnumGrantToolMaterial par2EnumToolMaterial)
	    {
	        super(par1);
