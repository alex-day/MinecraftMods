...
public class ItemAlexHoe extends Item {
	
	protected EnumAlexToolMaterial theToolMaterial;

    public ItemAlexHoe(int par1, EnumAlexToolMaterial par2EnumToolMaterial)
    {
        super(par1);
    ...
    {
    	if(theToolMaterial == EnumAlexToolMaterial.EPIC) {
    		return 4+theToolMaterial.getDamageVsEntity();
    	}
    	return 1;
    }
}
