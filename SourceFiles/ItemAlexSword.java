...
public class ItemAlexSword extends Item {
	
	private int weaponDamage;
    private final EnumAlexToolMaterial toolMaterial;

    public ItemAlexSword(int par1, EnumAlexToolMaterial par2EnumToolMaterial)
    {
        super(par1);
