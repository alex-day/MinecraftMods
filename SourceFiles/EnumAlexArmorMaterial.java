...
public enum EnumAlexArmorMaterial {
	...
	NETHER_QUARTZ(18, new int[]{2, 8, 5, 2}, 12);
    ...
    private EnumAlexArmorMaterial(int par3, int[] par4ArrayOfInteger, int par5)
    {
